...
<div class="data_list">
    ...
    <form name="myForm" class="form-search" method="post" action="${pageContext.request.contextPath}/selectFind/selectStuCode" style="padding-bottom: 0px">
        ...
        <span class="data_search">
                    ...
                    &nbsp;<input id="keyword" name="keyword" value="" type="text" placeholder="学号" style="width:120px;height: 30px;" class="input-medium search-query">
